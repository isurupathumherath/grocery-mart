...
<head>
    <meta charset="UTF-8">
    <title>Admin Login | Grocery Mart Online</title>
...
<body>
    <div class="admin-login-form" align="center" >
        ...
        <h2 align="center" style="font-size: 50px;">Admin Login - Grocery Mart</h2>
        <p style="font-size: 20px;">Please fill in admin credentials to login.</p>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div style="margin-top: 20px">
				...
				<input type="reset" style="margin-top: 10px" value="Reset">
			</div>
