...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT id FROM venderaccount WHERE username = ?";
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO venderaccount (username, password) VALUES (?, ?)";
...
<head>
    <meta charset="UTF-8">
    <title>Vendor Register | Grocery Mart Online</title>
...
<body>
    <div class="admin-register-form">
        <h2 align="center" style="font-size: 40px;">Vender Register - Grocery Mart</h2>
