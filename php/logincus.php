...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT user_id, username, password FROM users WHERE (username = ?) AND (u_type = 'customer')";
...
<head>
    ...
    <title>Customer Login | Grocery Mart Online</title>
...
<body>
    ...
    <div class="Customer-login-form" align="center" >
        ...
        <h2 align="center" style="font-size: 50px;">Customer Login - Grocery Mart</h2><br>
        <p style="font-size: 20px;">Please fill in Customer credentials to login.</p><br>
